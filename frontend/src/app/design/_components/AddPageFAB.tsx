...
export function AddPageFAB({ onPageAdded }: AddPageFABProps) {
  ...
  return (
    <button
      ...
      className="absolute bottom-6 left-1/2 -translate-x-1/2 z-40 flex items-center gap-2 px-4 py-2.5 rounded-xl bg-brand-medium hover:bg-brand-medium-dark border border-transparent text-brand-lighter text-sm font-medium shadow-lg hover:shadow-xl transition-all pointer-events-auto"
