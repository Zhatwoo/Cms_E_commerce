...
export const BottomPanel: React.FC<BottomPanelProps> = ({
  ...
  return (
    <div data-panel="bottom-tools" className="absolute bottom-0 left-0 right-0 z-50 pointer-events-none flex flex-col items-center">
      {/* Floating rectangle: only the 2 tools, centered */}
      <div
        className="pointer-events-auto flex items-center rounded-xl bg-[#2a2a2e]/95 backdrop-blur-md border border-white/[0.08] shadow-[0_4px_24px_rgba(0,0,0,0.4)] mb-3 px-1 py-1.5"
