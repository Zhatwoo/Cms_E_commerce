  ...
  element: React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Element as any,
          { is: Column as any, width: "min(100%, 640px)", padding: 20, canvas: true },
          ...
          React.createElement(Text as any, {
            text: "Review your selected product before checkout",
            fontSize: 14,
            color: "#64748b",
            marginBottom: 18,
          }),
          React.createElement(
            ...
            React.createElement(
              Element as any,
              { is: Column as any, width: "min(100%, 240px)", canvas: true },
              React.createElement(Text as any, {
            ...
            React.createElement(
              Element as any,
              { is: Column as any, width: "min(100%, 180px)", canvas: true },
              React.createElement(Text as any, {
          ...
          React.createElement(
            Element as any,
            { is: Row as any, canvas: true, marginTop: 14, gap: 10, alignItems: "center", flexWrap: "wrap" },
            React.createElement(
              Element as any,
              {
                is: Container as any,
        ...
        React.createElement(
          Element as any,
          { is: Column as any, width: "min(100%, 340px)", background: "#0f172a", borderRadius: 12, padding: 22, canvas: true },
