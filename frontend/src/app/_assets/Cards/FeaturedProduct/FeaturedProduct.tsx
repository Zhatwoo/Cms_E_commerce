  ...
  return (
    <div className="flex flex-col gap-0">
      <DesignSection title="Products" defaultOpen>
        ...
        {productSourceMode === "manual" ? (
          <div className="flex flex-col gap-2">
            <p className="m-0 text-[11px] text-builder-text-muted">Add products in order. The first items are shown as featured cards.</p>
          ...
          <p className="m-0 text-[11px] text-builder-text-muted">Auto mode shows the first active products from this project.</p>
        )}
      </DesignSection>
      ...
      <DesignSection title="Layout" defaultOpen={false}>
        ...
        <Row>
          <Label>Top</Label>
          <input type="number" min={0} max={200} value={paddingTop} onChange={(event) => setProp((props: FeaturedProductProps) => { props.paddingTop = Number.parseInt(event.target.value || "0", 10) || 0; })} className="h-7 w-20 rounded px-2 text-xs bg-builder-surface-3 border border-(--builder-border) text-builder-text focus:outline-none focus:border-(--builder-accent)" />
        </Row>
        <Row>
          <Label>Right</Label>
          <input type="number" min={0} max={200} value={paddingRight} onChange={(event) => setProp((props: FeaturedProductProps) => { props.paddingRight = Number.parseInt(event.target.value || "0", 10) || 0; })} className="h-7 w-20 rounded px-2 text-xs bg-builder-surface-3 border border-(--builder-border) text-builder-text focus:outline-none focus:border-(--builder-accent)" />
        </Row>
        <Row>
          <Label>Bottom</Label>
          <input type="number" min={0} max={200} value={paddingBottom} onChange={(event) => setProp((props: FeaturedProductProps) => { props.paddingBottom = Number.parseInt(event.target.value || "0", 10) || 0; })} className="h-7 w-20 rounded px-2 text-xs bg-builder-surface-3 border border-(--builder-border) text-builder-text focus:outline-none focus:border-(--builder-accent)" />
        </Row>
        <Row>
          <Label>Left</Label>
          <input type="number" min={0} max={200} value={paddingLeft} onChange={(event) => setProp((props: FeaturedProductProps) => { props.paddingLeft = Number.parseInt(event.target.value || "0", 10) || 0; })} className="h-7 w-20 rounded px-2 text-xs bg-builder-surface-3 border border-(--builder-border) text-builder-text focus:outline-none focus:border-(--builder-accent)" />
        </Row>
      </DesignSection>
