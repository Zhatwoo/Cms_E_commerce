    ...
    <div className="admin-dashboard-shell relative min-h-screen overflow-hidden px-4 py-8 sm:py-14">
      ...
      <div className="relative mx-auto w-full max-w-[540px]">
        ...
        <div className="admin-dashboard-panel rounded-[30px] border border-[rgba(177,59,255,0.2)] bg-[#f4f2ff] p-7 shadow-[0_14px_34px_rgba(123,78,192,0.2)] sm:p-8 md:px-10">
          <h1 className="text-center text-[2.9rem] font-extrabold leading-none tracking-[-0.02em] text-[#A63DFF] sm:text-[3rem]">
            REGISTER
          </h1>
          ...
          <form className="mt-10 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              <label htmlFor="name" className="pointer-events-none absolute left-5 top-0 z-20 -translate-y-1/2 bg-[#f4f2ff] px-2 text-xs font-medium leading-none text-[#C085FF]">
                Full Name
              </label>
              <input
                id="name"
          ...
          <div className="mt-6 flex items-center justify-between gap-8 text-sm">
            ...
            <Link href="/admindashboard/userAccount" className="whitespace-nowrap font-medium text-[#A63DFF] transition hover:opacity-75">
