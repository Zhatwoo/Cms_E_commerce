...
export function UserAccountSidebar() {
	...
	return (
		<div className="admin-dashboard-panel rounded-[26px] border border-[rgba(177,59,255,0.16)] bg-white p-5 shadow-[0_12px_28px_rgba(123,78,192,0.10)] md:p-6">
			<div className="space-y-2 text-sm">
				{tabs.map((tab) => (
					<Link
						key={tab.label}
						href={tab.href}
						className={`relative block w-full rounded-[18px] px-4 py-3 text-left text-[1.05rem] font-semibold leading-none transition-colors duration-200 ${
