...
export default function MonitoringAnalyticsPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex" suppressHydrationWarning>
            {/* Desktop Sidebar */}
            <div key="sidebar-wrapper" style={{ flexShrink: 0 }} suppressHydrationWarning>
                <AdminSidebar />
            </div>

            {/* Main Content */}
            <div className="flex-1 flex flex-col min-h-screen" suppressHydrationWarning>
                <div suppressHydrationWarning key="header-wrapper">
                    <AdminHeader />
                </div>
                <main className="flex-1 overflow-y-auto bg-slate-50" suppressHydrationWarning>
