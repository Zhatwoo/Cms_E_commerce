...
const PLANS: PlanItem[] = [
  ...
  },
  {
    ...
    badge: 'Popular',
    features: ['3GB Storage', '1 custom domain', 'Up to 500 products', 'Basic analytics', '24/7 email support'],
  ...
  },
  {
    ...
    features: ['10GB Storage', 'Unlimited domains', 'Unlimited products', 'Advanced analytics', 'Priority 24/7 support', 'API & webhooks'],
  ...
  },
  {
    ...
    features: ['Custom Storage', 'Custom limits', 'Dedicated manager', 'SLA guarantee', 'Custom integrations', 'White-label'],
