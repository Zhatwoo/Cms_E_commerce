                            ...
                            <>
                                ...
                                <div className="flex justify-end pt-4 border-t" style={{ borderColor: colors.border.faint }}>
                                    <button
                                        ...
                                        style={{ background: theme === 'dark' ? 'linear-gradient(90deg, #B13BFF 0%, #B36760 50%, #FFCC00 100%)' : 'linear-gradient(90deg, #9333ea 0%, #ec4899 100%)', textShadow: theme === 'dark' ? 'unset' : '0 1px 2px rgba(0,0,0,0.1)' }}
                                    >
