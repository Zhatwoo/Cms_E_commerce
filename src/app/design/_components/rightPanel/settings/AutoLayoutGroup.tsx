...
export const AutoLayoutGroup = ({
  ...
  return (
    <div className="flex flex-col gap-4">
      {/* Direction & Wrap */}
      <div className="flex items-center gap-2 bg-builder-surface-2 rounded-[10px] border border-(--builder-border) p-0.5">
        <button
          type="button"
          onClick={() => handleDirection("column")}
          className={`p-1.5 rounded-lg flex-1 flex justify-center ${flexDirection === "column" ? "bg-builder-surface-3 text-builder-text" : "text-builder-text-muted hover:text-builder-text"}`}
        ...
        <button
          ...
          className={`p-1.5 rounded-lg flex-1 flex justify-center ${flexDirection === "row" ? "bg-builder-surface-3 text-builder-text" : "text-builder-text-muted hover:text-builder-text"}`}
          title="Horizontal (Row)"
        >
          <ArrowRight size={16} />
        </button>
        <div className="w-px h-4 bg-builder-border-mid mx-1" />
        <button
          type="button"
          onClick={handleWrap}
          className={`p-1.5 rounded-lg flex-1 flex justify-center ${flexWrap === "wrap" ? "bg-builder-accent text-black" : "text-builder-text-muted hover:text-builder-text"}`}
          title="Wrap Items"
        >
          <WrapText size={16} />
        </button>
      ...
      <div className="flex gap-4">
        {/* 3x3 Matrix */}
        <div className="bg-builder-surface-2 p-1.5 rounded-xl inline-grid grid-cols-3 gap-2">
        ...
        <div className="flex flex-col justify-between flex-1 gap-2">
          <div className="flex flex-col gap-1">
            <label className="text-[12px] text-builder-text font-base">Gap</label>
            <div className="bg-builder-surface-2 px-2.5 rounded-lg">
              <NumericInput
                value={gap}
          ...
          <div className="flex flex-col gap-1">
            <label className="text-[12px] text-builder-text font-base">Distribute</label>
            <div className="bg-builder-surface-2 px-2 rounded-lg">
              <select
                className="text-xs bg-builder-surface-2 text-builder-text py-1.5 px-2.5 focus:outline-none appearance-none"
